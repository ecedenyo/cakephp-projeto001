...
class ArticlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'articles_cat_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'published' => 1,
                'created' => '2019-07-18 17:10:18',
                'modified' => '2019-07-18 17:10:18'
            ],
        ];
        parent::init();
    }
